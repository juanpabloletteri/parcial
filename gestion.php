  ...
  <div class="login-head">
    ...
    <button type="button" class="round medium green button" onclick="salir()">Logout</button>
      ...
      <form onsubmit="return false" >
        <p><input type="text" name="patente" id="patente" placeholder="Ingrese Descripcion"></p>
        <p><input type="number" name="porcentaje" id="porcentaje" placeholder="Ingrese Porcentaje"></p>
        <br>
